<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script src="${pageContext.request.contextPath }/resource/lib/parallax/parallax.min.js"></script>
    <script src="${pageContext.request.contextPath }/resource/lib/isotope/isotope.pkgd.min.js"></script>
    <script src="${pageContext.request.contextPath }/resource/lib/lightbox/js/lightbox.min.js"></script>
